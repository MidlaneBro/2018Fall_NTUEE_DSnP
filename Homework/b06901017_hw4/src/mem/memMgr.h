...
#define toSizeT(t)      (t%SIZE_T==0)? t:(t<0)? (t/SIZE_T)*SIZE_T:(t/SIZE_T+1)*SIZE_T  // TODO
//
// To demote 't' to the nearest multiple of SIZE_T
// e.g. Let SIZE_T = 8;  downtoSizeT(9) = 8, downtoSizeT(100) = 96
#define downtoSizeT(t)  (t<0)? (t/SIZE_T-1)*SIZE_T:(t/SIZE_T)*SIZE_T  // TODO
